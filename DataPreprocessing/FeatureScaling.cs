...
public class ZScore
{
    ...
    internal double StandardDeviation(PrimitiveDataFrameColumn<double> x, double mean)
    {
...
public class MinMax
{
    ...
    public PrimitiveDataFrameColumn<double> Normalize(PrimitiveDataFrameColumn<double> x)
    {
        ...
        {
            throw new Exception(
                "Min and Maximum element cannot be of same value there is a problem with this please fix this issue"
            );
        }
        for (long i = 0; i < x.Length; i++)
        {
